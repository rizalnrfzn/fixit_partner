...
ThemeData themeLight(BuildContext context) => ThemeData(
      ...
      bottomNavigationBarTheme: const BottomNavigationBarThemeData().copyWith(
        ...
        selectedItemColor: Palette.blueLatte,
...
ThemeData themeDark(BuildContext context) => ThemeData(
      ...
      colorScheme: const ColorScheme.dark().copyWith(
        primary: Palette.blueMocha,
        secondary: Palette.blueMocha,
      ),
      textTheme: TextTheme(
        displayLarge: Theme.of(context).textTheme.displayLarge?.copyWith(
              fontSize: Dimens.displayLarge,
      ...
      bottomNavigationBarTheme: const BottomNavigationBarThemeData().copyWith(
        ...
        selectedItemColor: Palette.blueMocha,
        unselectedItemColor: Palette.subTextDark,
      ),
      drawerTheme: const DrawerThemeData().copyWith(
        elevation: Dimens.zero,
        surfaceTintColor: Palette.backgroundDark,
