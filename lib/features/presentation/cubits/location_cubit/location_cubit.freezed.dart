...
mixin _$LocationState {
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(Geolocation? geolocation, Direction? direction,
            LatLng? currentLocation)?
        success,
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl(this.geolocation, this.direction, this.currentLocation);
  ...
  @override
  String toString() {
    return 'LocationState.success(geolocation: $geolocation, direction: $direction, currentLocation: $currentLocation)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, geolocation, direction, currentLocation);
  ...
  TResult when<TResult extends Object?>({
    ...
    return success(geolocation, direction, currentLocation);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return success?.call(geolocation, direction, currentLocation);
  }
...
abstract class _Success implements LocationState {
  const factory _Success(
      final Geolocation? geolocation,
      final Direction? direction,
      final LatLng? currentLocation) = _$SuccessImpl;
