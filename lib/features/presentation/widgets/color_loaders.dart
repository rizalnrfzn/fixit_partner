            ...
            child: Stack(
              children: <Widget>[
                ...
                Transform.translate(
                  ...
                  child: Dot(
                    radius: dotRadius,
                    color: Theme.of(context).extension<MyAppColors>()!.yellow,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
                  ...
                  child: Dot(
                    radius: dotRadius,
                    color: Theme.of(context).extension<MyAppColors>()!.green,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
                  ...
                  child: Dot(
                    radius: dotRadius,
                    color: Theme.of(context).extension<MyAppColors>()!.flamingo,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
                  ...
                  child: Dot(
                    radius: dotRadius,
                    color: Theme.of(context).extension<MyAppColors>()!.lavender,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
                  ...
                  child: Dot(
                    radius: dotRadius,
                    color: Theme.of(context).extension<MyAppColors>()!.pink,
                  ),
                ),
              ],
            ),
